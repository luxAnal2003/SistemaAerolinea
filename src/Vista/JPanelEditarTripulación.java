 ...
 * @author admin
 */
public class JPanelEditarTripulación extends javax.swing.JPanel {

    private TripulacionController tripuController;
    private int idTripulanteSeleccionado = 0;

    /**
     * Creates new form JPanelAeronave
     */
    public JPanelEditarTripulación() {
        initComponents();
    ...
    private JPanel crearTarjeta(Tripulacion t) {
        ...
        JLabel txtLicencia1 = new JLabel("Licencia:");
        txtLicencia1.setBounds(65, 75, 60, 18);
        txtLicencia1.setFont(new Font("Segoe UI", Font.BOLD, 11));
        ...
        card.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                idTripulanteSeleccionado = t.getIdTripulante();

                txtNombres.setText(t.getNombre());

                txtApellidos.setText(t.getApellido());

                txtCedula.setText(t.getCedula());

                txtLicencia.setText(t.getLicencia());

                cbxRol.setSelectedItem(t.getRol());
            }
        });
        return card;
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Editar Tripulante");
        ...
        jPanel4.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 120, 30));
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if (idTripulanteSeleccionado == 0) {

            JOptionPane.showMessageDialog(
                    this,
                    "Seleccione un tripulante"
            );
        ...
        trip.setIdTripulante(idTripulanteSeleccionado);
        ...
        boolean actualizado = tripuController.actualizarTripu(trip);
